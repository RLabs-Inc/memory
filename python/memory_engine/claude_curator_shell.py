"""
Claude-based Memory Curator using Shell CLI

Uses subprocess to call claude CLI directly, avoiding the Python SDK bug
that truncates responses at 169 characters.
"""
