...
try:
    from .core_curator_only import MemoryEngineCuratorOnly as MemoryEngineWithCurator, ConversationContext
    curator_available = True
except ImportError:
    curator_available = False
    from .core import MemoryEngine as MemoryEngineWithCurator, ConversationContext
...
class MemoryAPIWithCurator:
    ...
    def _setup_routes(self):
        ...
        async def test_curator():
            ...
            try:
                from .claude_curator_shell import ClaudeCuratorShell
...
if __name__ == "__main__":
    ...
    run_server(use_claude_curator=True)